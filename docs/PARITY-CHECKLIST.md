...
_Last updated: Phase 0 (gap analysis). Nothing implemented yet this phase._
...
- [~] ACCESS-1 Brand-access matrix (per-user list; UI only)
- [~] ROLE-1 Permission sets (display only)
